---
title: "Session 1 — Probability & Statistics (recap)"
layout: default
parent: Advanced track
nav_order: 1
---

# Session 1 — Probability & Statistics (recap)

*Overview of this session's topics — to be added by Sara.*
...
<!--
  ...
  - ✏️ [Exercise sheet]({{ '/assets/advanced/Q_Ex1_Maths_training_DEC_2026.pdf' | relative_url }})
  - ✅ [Solutions]({{ '/assets/advanced/Sol_Ex1_Maths_training_DEC_2026.pdf' | relative_url }})
-->
